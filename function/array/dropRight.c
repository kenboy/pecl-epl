 ...
 */
const zend_internal_arg_info arginfo_collect_method_drop_right[] = {
	{ (const char*)(zend_uintptr_t)(-1), 0, ZEND_RETURN_VALUE, 0 },
	ZEND_ARG_TYPE_INFO(0, n, IS_LONG, 0)
};

PHPAPI ZEND_NAMED_FUNCTION(epl_collect_method_drop_right)
{
	zval *array, rv;
	zend_long n = 1;
 ...
 */
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_epl_function_drop_right, ZEND_RETURN_VALUE, -1, IS_ARRAY, 0)
